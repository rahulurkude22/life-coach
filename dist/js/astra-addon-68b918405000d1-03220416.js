(astraToggleSetupPro = function (e, t, a) {
  ...
  if (
      ...
      (o =
        "off-canvas" === e || "full-width" === e
          ? ((n = document.querySelectorAll(
            ...
            (s = t.classList.contains("ast-header-break-point")
    ...
    for (var r = 0; r < o; r++)
      if (
        (l ||
          (s[r].setAttribute("data-index", r), a[r]) ||
          ((a[r] = s[r]),
          s[r].removeEventListener("click", astraNavMenuToggle),
          s[r].addEventListener("click", astraNavMenuToggle, !1)),
        void 0 !== n[r])
      )
        for (var i, c = 0; c < n.length; c++)
          if (
            ...
            (i = document
              ...
              : n[c].querySelectorAll("ul.main-header-menu .ast-menu-toggle"))
              .length
          )
  ...
  (astraNavMenuTogglePro = function (e, t, a, o) {
    ...
    if ("desktop" === e.currentTarget.trigger_type)
      null !== l &&
        ...
        l.classList.contains("toggle-on")
          ? (l.style.display = "block")
          : (l.style.display = "")),
        astraToggleClass(n, "toggled"),
        n.classList.contains("toggled")
          ? (t.classList.add("ast-main-header-nav-open"),
            "dropdown" === a && (s.style.display = "block"))
      ...
      (e = document.querySelectorAll(
        ...
        (n = !1);
      if (
        (null !== o.closest("#ast-fixed-header") &&
          ((e = document.querySelectorAll(
        ...
        return !1;
      for (
        var r = e[l].querySelectorAll(".menu-item-has-children"), i = 0;
        i < r.length;
        i++
      ) {
        r[i].classList.remove("ast-submenu-expanded");
        for (
          var c = r[i].querySelectorAll(".sub-menu"), d = 0;
          d < c.length;
          d++
        )
      ...
      -1 !==
        (o.getAttribute("class") || "").indexOf("main-header-menu-toggle") &&
  ...
  astraColorSwitcher = {
    ...
    switchIcon: function () {
      this.switcherButtons?.forEach((a) => {
        var [o, n] = a?.querySelectorAll(".ast-switcher-icon");
        if (o && n) {
          let [e, t] = this.isSwitched ? [n, o] : [o, n];
        ...
        a?.setAttribute(
          "aria-label",
          a?.dataset?.[o] || "Switch color palette."
        );
      });
    },
...
var accountPopupTrigger = function () {
  if (
    ...
    "login" === astraAddon.hf_account_logout_action
  ) {
    var e,
    ...
    0 < n("header .site-logo-img img").length &&
      (-1 ===
        (e =
          0 ==
          (e =
            void 0 === (e = (m = n("header .site-logo-img img")).attr("height"))
              ? m.height()
              : e)
            ? ""
            : e)
    ...
    (_ || g || b) &&
      ...
      jQuery(l).on("ready astLayoutWidthChanged", function (e) {
        if ("astLayoutWidthChanged" === e.type) {
          if (!(parseInt(_) || parseInt(b) || parseInt(g))) return;
        ...
        "1" == j
          ...
          : "none" == f
          ? c
            ? ("both" === w ? ["desktop", "mobile"] : [w]).forEach(function (
                e
              ) {
                var t;
                ("1" != g && "on" != g && "disabled" != g) ||
      ...
      (o.hasClass("full-width-mega") ||
        ...
        "ast-desktop-toggle-menu" !== o.parent().attr("id")
          ? ((e = m.width()),
            ...
            (m =
              (a = o.offset()).left -
              (t.left + parseFloat(m.css("paddingLeft")))),
            ...
            o.hasClass("custom-width-mega") &&
              ...
              (i = parseInt(i)) <= e
                ? ((l = parseInt(e - i)), (n = parseInt(m - l)), t.left)
                : ((l = parseInt(i - e)), (n = parseInt(m + l)), t.left)),
            o.hasClass("menu-container-width-mega") &&
              ...
              (d =
                parseInt(e) -
                o.outerWidth() -
                parseInt($target_container.width() - u))),
            o.hasClass("full-width-mega")
              ? (o
                  .find(".astra-full-megamenu-wrapper")
                  .css({ left: "-" + r + "px", width: s }),
              ...
              ? astra.isRtl
                ? ((l = t.left + e - (a.left + o.outerWidth())),
                  o
                    .find(".astra-megamenu")
                    .css({ right: "-" + l + "px", width: e })
                    .data("astra-hover-right", l))
                : o
                    .find(".astra-megamenu")
...
apply_megamenu_width_styles(),
  ...
  [].slice.call(items).forEach(function (h) {
    ...
    (p.hasClass("full-width-mega") ||
      ...
      ((g = jQuery(g).closest(".ast-container")),
        ...
        astra.is_header_footer_builder_active ||
          ...
          "ast-desktop-toggle-menu" !== p.parent().attr("id")
            ? ((t = g.width()),
              ...
              (l =
                (s = p.offset()).left -
                (a.left + parseFloat(g.css("paddingLeft")))),
              ...
              p.hasClass("custom-width-mega") &&
                ((d = (d =
                  window
                    .getComputedStyle(
                      p.find(".astra-mega-menu-width-custom")[0],
                      "::before"
                    )
                ...
                (i =
                  (d = parseInt(d)) <= t
                    ? ((i = parseInt(t - d)), (n = parseInt(l - i)), a.left - n)
                    : ((i = parseInt(d - t)),
                      (n = parseInt(l + i)),
                      a.left + n))),
              p.hasClass("menu-container-width-mega") &&
                ...
                c.hasClass("ast-above-header")
                  ...
                  : c.hasClass("ast-below-header") &&
                    (o = jQuery(".ast-below-header-actual-nav")),
                (t =
                  ($target_container = o.length ? o : p.parent("ul")).width() +
                  "px"),
                (o =
                  jQuery(window).width() -
                  ($target_container.offset().left +
                ...
                (u =
                  parseInt(t) -
                  p.outerWidth() -
                  parseInt($target_container.width() - o))),
              p.hasClass("full-width-mega")
                ? (p
                    .find(".astra-full-megamenu-wrapper")
                    .css({ left: "-" + f + "px", width: r }),
                ...
                ? astra.isRtl
                  ...
                  : p
                      .find(".astra-megamenu")
                      .css({ left: "-" + l + "px", width: t })
                : ((f = void 0 !== (o = p.data("astra-hover-right")) ? o : u),
                  astra.isRtl
                    ? p
                        .find(".astra-megamenu")
                        .css({ right: "-" + f + "px", width: t })
                        .data("astra-hover-right", f)
                    : p
                        .find(".astra-megamenu")
                        .css({ left: "-" + l + "px", width: t })))
            : astra.isRtl
