        ...
        >
          ...
          >
            <div className="e-con-inner">
              ...
              >
                <div className="elementor-widget-container">
                  <p>Want a *free* mini meditation to boost your confidence?</p>
                </div>
              </div>
              <div
            ...
            >
              <div className="e-con-inner">
                    ...
                    <div className="elementor-widget-container">
                      <a href="/work-together/#c-suite-training">
                        <img
                          ...
                          width="600"
                          height="579"
                          src="images/CSUITE_final-1.png"
                          className="attachment-medium_large size-medium_large wp-image-119858"
                          alt="C-SUITE Training"
                          srcSet="images/CSUITE_final-1.png 600w, images/CSUITE_final-1-300x290.png 300w, images/CSUITE_final-1-200x193.png 200w, images/CSUITE_final-1-400x386.png 400w"
                ...
                >
                  ...
                  >
                    <div className="elementor-widget-container">
                      <a href="/work-together/#Keynotes">
                        <img
                          loading="lazy"
                          decoding="async"
                          width="600"
                          height="579"
                          src="images/KEYNOTES_final-1.png"
                          className="attachment-medium_large size-medium_large wp-image-119859"
                          alt="KEYNOTES & Workshops"
                          srcSet="images/KEYNOTES_final-1.png 600w, images/KEYNOTES_final-1-300x290.png 300w, images/KEYNOTES_final-1-200x193.png 200w, images/KEYNOTES_final-1-400x386.png 400w"
                          sizes="(max-width: 600px) 100vw, 600px"
                        />{" "}
                      </a>
                    </div>
                ...
                >
                  ...
                  >
                    <div className="elementor-widget-container">
                      <a href="/work-together/#1-on-1-intensives">
                        <img
                          loading="lazy"
                          decoding="async"
                          width="600"
                          height="579"
                          src="images/1ON_final1-1.png"
                          className="attachment-medium_large size-medium_large wp-image-119860"
                          alt="1-ON-1 Intensive"
                          srcSet="images/1ON_final1-1.png 600w, images/1ON_final1-1-300x290.png 300w, images/1ON_final1-1-200x193.png 200w, images/1ON_final1-1-400x386.png 400w"
                          sizes="(max-width: 600px) 100vw, 600px"
                        />{" "}
                      </a>
                    </div>
                    ...
                    <div className="rotating_testimonials_quotes">
                      <div className="slide-0">
                        <div className="slide-content">
                          ...
                          <p>
                            Cortney is deeply committed to creating good in the
                      ...
                      <div className="slide-1">
                        <div className="slide-content">
                          ...
                          <p>
                            ...
                            absolutely exceeded every expectation I had for the
                            event!
                          </p>
                      ...
                      <div className="slide-2">
                        <div className="slide-content">
                          ...
                          <p>
                            Cortney provides an easy-to-follow roadmap to living
                            a sustainable life where anything and everything is
                            possible.
                          </p>
